...
<body>
	...
	<div class="block flex-center cyan darken-1 full-window">
		<div class="container">
			<div class="row">
				...
				<div class="center-align full-w white-text">
					В Кемерове 4 центра обслуживания абонентов	в Центральном, Ленинском, Рудничном и Заводском районах. Чтобы определить, подключен ли к Good Line ваш дом, воспользуйтесь <a class="white-text" href="https://goodline.info/pomosh/podklyuchen-li-vash-dom.html">формой</a>.</div>
				</div>
			</div>
		</div>
							...
							<div class="row">
								...
								<div class="col s6">
									<div class="card-content">
										<div class="flow-text">Безлимитный интернет с постоянной скоростью 100 Мбит/сек, самый быстрый в России
										</div>
										У нас самый быстрый интернет в России по данным независимого рейтинга NetIndex, составленного на основе данных мирового эксперта по замерам скорости — SpeedTest. Мы — лидер интернет-рынка Кузбасса!
									Подключаем в 17 городах области. В том числе и частные дома в Кемерове, Белове и Юрге.</div>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col s6">
									<div class="card-content">
										...
										Мы организовали резервные каналы до каждого из подключенных городов, поэтому повреждение линий не повлияет на надёжность связи. Благодаря оптоволоконной сети между всеми городами присутствия, качество нашей связи всегда на высоте.
										Стабильное подключение к интернету
										А еще у нас самое современное  оборудование и качество  подключения всегда на высоте благодаря оптоволоконному кабелю.
									</div>
								</div>
								<div class="col s6">
									<div class="card-image">
							...
							<div class="row">
								...
								<div class="col s6">
									<div class="card-content">
										...
										Мы создали крупнейший в Кузбассе контакт-центр — ни один Ваш звонок не останется без ответа. Работаем 24 часа в сутки!
										Приложение «Техподдержка Good Line»
										Умный робот Лена поможет вам решить любой вопрос, а при необходимости к беседе подключится «живой» оператор. Также в приложении вы сможете оплатить услуги и подключить автоплатеж. Просто и безопасно.
									</div>
								</div>
							</div>
						</div>
		...
		<div class="block flex-center full-window background-1">
			<div class="container">
				<div class="row">
						...
						<div class="tariff__item" id="701">
							...
							<div class="tariff__item_body flex-center">
								<div class="tariff__item_body--speed tariff__item_body--item speed-medium">
									<div class="tariff__item_body--header"><a href="start/internet/podklyuchit-internet-ot-good-line.html">Интернет</a></div>
								...
								<div class="tariff__item_body--speed green tariff__item_body--item tariff__item_body--btv">
									<div class="tariff__item_body--header"><a href="start/bolshoe-tv/podklyuchit-czifrovoe-tv-ot-good-line.html">Большое ТВ</a></div>
								...
								<div class="tariff__item_body--speed tariff__item_body--item tariff__item_body--console">
									<div class="tariff__item_body--header"><a href="start/bolshoe-tv/oborudovanie.html">Приставка</a></div>
						...
						<div class="tariff__item" id="801">
							...
							<div class="tariff__item_body flex-center">
								...
								<div class="tariff__item_body--speed tariff__item_body--item tariff__item_body--wifi">
									<div class="tariff__item_body--header"><a href="uslugi/servis-i-oborudovanie/oborudovanie/router-good-line.html">Wi-Fi роутер</a></div>
