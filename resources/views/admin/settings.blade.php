        ...
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    ...
                    <li class="tab col s4"><a href="#test2">Вконтакте</a></li>
                    <li class="tab col s4"><a href="#test4">Заказы</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card card-panel">
                ...
                <form method="POST" action="/admin/settings/set">
                    ...
                    <div class="card-action">
                        ...
                        @elseif ($vk != '0')
                            <a href="/admin/settings/logout" id="vk_logout" class="btn right waves-effect waves-light">Отвязать ВК</a>
                        @endif
                    </div>
                </form>
            </div>
