        ...
        <div class="row">
            <div class="header-info">
                <div class="col s12 text-center">
                    <h1 class="wow text-shadow fadeIn">{{--$tag['full_title']--}}</h1>
                    <p class="lead text-shadow wow fadeIn" data-wow-delay="0.5s">{{--$tag['header_info']--}}</p>
                </div>
                ...
                <div class="card-panel">
                    <form action="/" method="post" id="form">
                        <div class="input-field">
                            <input name="form_name" id="form_name" type="text" class="validate">
                            <label for="form_name">Ф.И.О</label>
                        </div>
                        <div class="input-field">
                            <input name="form_email" id="form_email" type="text" class="validate">
                            <label for="form_email">Почта</label>
                        </div>
                        <div class="input-field">
                            <input name="form_phone" id="form_phone" type="text" class="validate">
                            <label for="form_phone">Номер телефона</label>
                        </div>
                        <div class="input-field">
                            <input name="form_lorem" id="form_lorem" type="text" class="validate">
                            <label for="form_lorem">Lorem impsum</label>
                        </div>
                        <div class="input-box">
                            <label>
                                <input name="form_grant" type="checkbox">
                                <span>Даю соглаие</span>
                            </label>
                        </div>
                        <div class="input-box">
